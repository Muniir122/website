/*1657043278,,JIT Construction: v1005788747,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/en_US\/sdk\/xfbml.customerchat.js"
                });
                __d("JSSDKXDConfig", [], {
                ...
                __d("fb-error", ["performanceNow", "removeFromArray"], (function(a, b, c, d, e, f) {
                    ...
                    function wa(a) {
                        ...
                        if (b != null && typeof b === "object" && (b.name == null || b.name === "" || b.message == null || b.message === "")) try {
                            c = i("UnhandledRejection: %s", ES("JSON", "stringify", !1, b)), c.loggingSource = "ONUNHANDLEDREJECTION"
                        } catch (a) {
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._( /*FBT_CALL*/ "Cancel" /*FBT_CALL*/ ) + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._( /*FBT_CALL*/ "Cancel" /*FBT_CALL*/ ) + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._( /*FBT_CALL*/ "Loading..." /*FBT_CALL*/ ) + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return o.create({
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookURI", "isInstagramURI", "resolveWindow", "sdk.Event", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    var h = new(c("Queue"))(),
                        i = "parent",
                        j = null,
                    ...
                    function s(a, b) {
                        if (b != null && b !== "native" && !c("isFacebookURI")(new(c("sdk.URI"))(b)) && !c("isInstagramURI")(new(c("sdk.URI"))(b))) return;
                        if (typeof a === "string") {
                            if (/^FB_RPC:/.test(a)) {
                    ...
                    function u(a) {
                        ...
                        window.addEventListener("message", function(a) {
                            ...
                            if (typeof b === "string") s(b, e);
                                ...
                                d("Log").warn("Received message of type %s from %s, expected a string. %s", typeof b, n, ES("JSON", "stringify", !1, b));
                                return
                            }
                        });
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f, g) {
                    ...
                    var p = {
                        ...
                        iframe: function(a) {
                            ...
                            var b = function() {
                                    var b = ES("JSON", "stringify", !1, {
                                        error_code: 4201,
                                        error_message: c("sdk.fbt")._( /*FBT_CALL*/ "User canceled the Dialog flow" /*FBT_CALL*/ )
                                    });
                        ...
                        _handleResizeMessage: function(a, b) {
                            ...
                            c("sdk.XD").inform("resize.ack", b || babelHelpers["extends"]({}, null), "parent.frames[" + a.name + "]");
                ...
                __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "isNumberLike"], (function(a, b, c, d, e, f, g) {
                    function a(a) {
                        ...
                        for (var f in b) Object.prototype.hasOwnProperty.call(b, f) && e.setAttribute(f, b[f]);
                ...
                __d("ChatPluginSDKPreLoggingUtils", ["CORSRequest", "UrlMap", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a, b, e) {
                        ...
                        var g = c("performanceAbsoluteNow")(),
                            h = d("UrlMap").resolve("www") + "/plugins/customer_chat/SDK/";
                        f = (f = b.request_time) != null ? f : void 0;
                        var i = 0;
                        typeof f === "number" && e && (i = g - f);
                        b.request_time = g;
                        c("CORSRequest").execute(h, "get", babelHelpers["extends"]({}, b, {
                            event_name: a,
                            loading_time: i
                        }), function() {
                            return null
                ...
                __d("ChatPluginStyleUtils", ["LiveChatPluginConstants"], (function(a, b, c, d, e, f, g) {
                    ...
                    function J(a, b, c, d, e) {
                        ...
                        b = Object.fromEntries(ES("Object", "entries", !1, c).sort());
                    ...
                    function N(a, b) {
                        ...
                        d = Object.fromEntries(ES("Object", "entries", !1, a).sort());
                        return d
                    }
                    ...
                    function O(a, b) {
                        ...
                        c = a ? b : d;
                        a = Object.fromEntries(ES("Object", "entries", !1, c).sort());
                        return a
                    }
                    ...
                    function P(a, b) {
                        ...
                        a = a ? b : c;
                        b = Object.fromEntries(ES("Object", "entries", !1, a).sort());
                        return b
                    }
                    ...
                    function Q(a) {
                        ...
                        a = Object.fromEntries(ES("Object", "entries", !1, a).sort());
                        return a
                    }
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointIconEnum", "ChatPluginEntryPointLabelEnum", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "ChatPluginStyleUtils", "DOMPlugin", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.fbt", "sdk.feature", "uuid"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, e, f, g) {
                            ...
                            d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_facade_create", i.params, !1);
                            d("sdk.DOM").remove(b);
                        ...
                        e.render = function(a) {
                            ...
                            a = d("UrlMap").resolve("www") + "/plugins/customer_chat/facade/";
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                ...
                                if (b.$ChatDOMFacade9 === "none") {
                                    ...
                                    d("sdk.DOM").html(b.$ChatDOMFacade3, b.$ChatDOMFacade16(e))
                                }
                                ...
                                d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_facade_load", b.params)
                            });
                        ...
                        e.$ChatDOMFacade19 = function() {
                            ...
                            if (this.$ChatDOMFacade9 === "none") {
                                ...
                                if (this.$ChatDOMFacade10 === "none") {
                                    ...
                                    d("sdk.DOM").html(this.$ChatDOMFacade3.children[0], this.$ChatDOMFacade21(b, a) + this.$ChatDOMFacade3.children[0].innerHTML);
                ...
                __d("IframePluginClass", ["Log", "QueryString", "UrlMap", "guid", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.Observable", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    a = function(a) {
                        ...
                        function b(b, e, f, g) {
                            ...
                            h.subscribe("xd.resize", d("sdk.PluginUtils").resizeBubbler(i));
                            h.subscribe("xd.resize.flow", d("sdk.PluginUtils").resizeBubbler(i));
                            h.subscribe("xd.resize.flow", function(a) {
                                ES("Object", "assign", !1, h.iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), d("sdk.PluginUtils").resize(h.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), h.updateLift(), window.clearTimeout(h.$IframePluginClass1)
                            });
                            h.subscribe("xd.resize", function(a) {
                                ES("Object", "assign", !1, h.iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), d("sdk.PluginUtils").resize(h.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), d("sdk.PluginUtils").resize(h.iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), h.$IframePluginClass2 = !0, h.updateLift(), window.clearTimeout(h.$IframePluginClass1)
                            });
                            h.subscribe("xd.resize.iframe", function(a) {
                                d("sdk.PluginUtils").resize(h.iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), h.$IframePluginClass2 = !0, h.updateLift(), window.clearTimeout(h.$IframePluginClass1)
                            });
                            ...
                            var j = d("UrlMap").resolve("www") + "/plugins/" + f + ".php?",
                                k = {};
                            ...
                            h.subscribe("xd.refreshLoginStatus", function() {
                                d("sdk.AuthUtils").removeLogoutState(), c("sdk.Auth.LoginStatus").getLoginStatus(ES(h.inform, "bind", !0, babelHelpers.assertThisInitialized(h), "login.status"), !0)
                            });
                            ...
                            h.iframeOptions = {
                                ...
                                name: l,
                                width: h.config.mobile_fullsize && c("sdk.UA").mobile() ? void 0 : k.width || 1e3,
                                height: k.height || 1e3,
                                style: {
                                    border: "none",
                                    visibility: "hidden"
                ...
                __d("getFacebookOriginForTarget", ["Log"], (function(a, b, c, d, e, f, g) {
                    function a(a, b) {
                        ...
                        window.addEventListener("message", function(c) {
                            c.source === b && c.data.xdArbiterAck && (/\.facebook\.com$/.test(c.origin) && /^https:/.test(c.origin) ? e === !1 && (e = !0, d("Log").debug("initXdArbiter got xdArbiterAck from " + c.origin), a(c.origin)) : d("Log").error("xdAbiterAck was not from Facebook: ", c.origin))
                        }, !1);
                        b.postMessage({
                            xdArbiterSyn: !0
                        }, "*");
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, c, e, f) {
                            ...
                            g.$CustomerChat18();
                            d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_dialog_iframe_create", g.params, !1);
                            return g
                        }
                        var e = b.prototype;
                        e.$CustomerChat17 = function() {
                            ...
                            a = d("UrlMap").resolve("www") + "/plugins/" + this.tag + ".php?";
                        ...
                        e.$CustomerChat18 = function() {
                            var a = this;
                            this.subscribe("render", function() {
                                d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_dialog_iframe_load", a.params)
                            });
                        ...
                        e.$CustomerChat21 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat2 = j, b.$CustomerChat26(), b.$CustomerChat27(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                        ...
                        e.$CustomerChat32 = function(a) {
                            if (!a) return;
                            d("sdk.DOM").setStyle(a, "minHeight", "100px")
                        };
                        return b
                    }(c("IframePluginClass"));
                    g["default"] = a
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = {
                        continueWith: c("sdk.fbt")._( /*FBT_CALL*/ "Continue with {facebook_app_name} or {instagram_app_name}" /*FBT_CALL*/ ),
                        continueWithShort: c("sdk.fbt")._( /*FBT_CALL*/ "{facebook_app_name} or {instagram_app_name}" /*FBT_CALL*/ ),
                        loginButtonAriaLabel: c("sdk.fbt")._( /*FBT_CALL*/ "Continue with Facebook or Instagram" /*FBT_CALL*/ ),
                        logout: c("sdk.fbt")._( /*FBT_CALL*/ "Logout" /*FBT_CALL*/ ),
                        logoutButtonAriaLabel: c("sdk.fbt")._( /*FBT_CALL*/ "Logout the current website" /*FBT_CALL*/ ),
                        titleText: c("sdk.fbt")._( /*FBT_CALL*/ "Choose Account" /*FBT_CALL*/ ),
                        promptText: c("sdk.fbt")._( /*FBT_CALL*/ "Which account would you like to use to log in?" /*FBT_CALL*/ ),
                        facebookText: c("sdk.fbt")._( /*FBT_CALL*/ "Log in with Facebook" /*FBT_CALL*/ ),
                        facebookTextShort: c("sdk.fbt")._( /*FBT_CALL*/ "Log in" /*FBT_CALL*/ ),
                        instagramText: c("sdk.fbt")._( /*FBT_CALL*/ "Log in with Instagram" /*FBT_CALL*/ ),
                        disambiguationDialogAriaLabelText: c("sdk.fbt")._( /*FBT_CALL*/ "Log in with Facebook or Instagram" /*FBT_CALL*/ ),
                        fbButtonText: c("sdk.fbt")._( /*FBT_CALL*/ "Continue with Facebook" /*FBT_CALL*/ ),
                        igButtonText: c("sdk.fbt")._( /*FBT_CALL*/ "Continue with Instagram" /*FBT_CALL*/ )
                    };
                ...
                __d("sdk.XFBML.MessengerCheckbox", ["FB", "IframePlugin", "Log", "PluginAttrTypes", "sdk.XD"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                ...
                __d("sdk.CustomTags", ["sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.CustomerChatWrapper", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.MessengerCheckbox", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = {
                        ...
                        messenger_checkbox: b("sdk.XFBML.MessengerCheckbox"),
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    var h = function() {
                        function a(a) {
                            ...
                            e.textContent = c("sdk.fbt")._( /*FBT_CALL*/ "Share to Facebook" /*FBT_CALL*/ );
                ...
                __d("sdk.init-public", ["FB", "QueryString", "sdk.AppEvents", "sdk.ErrorHandling", "sdk.Event", "sdk.Frictionless", "sdk.XD", "sdk.init"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        b("sdk.XD"), b("sdk.AppEvents"), b("sdk.Frictionless"), window.setTimeout(function() {
                            ...
                            __buffer && __buffer.opts && c("sdk.init")(__buffer.opts)
                        }, 0)
                    }
                    e = {
                        initialize: a
                ...
                __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    ...
                    function a() {
                        if (i) {
                            var a = c("sdk.Runtime").getSDKUrl(),
                                b = null,
                                e = h.getEntriesByType("resource").filter(function(b) {
                                    return ES(b.name, "startsWith", !0, a)
                                });
                            if (e.length > 1)
                                if (e > 2) e = null;
                                else {
                                    var f = ES(e, "findIndex", !0, function(b) {
                                        return ES(b.name, "startsWith", !0, a + "?hash=")
                                    });
                                    !f ? e = null : (b = e.splice(f)[0], e = e[0])
                                }
                            else if (e.length === 1) {
                                f = document.getElementById("facebook-jssdk-iframe");
                                f && f instanceof HTMLIFrameElement && (b = f.contentWindow.performance.getEntriesByType("resource").find(function(b) {
                                    return ES(b.name, "startsWith", !0, a)
                                }));
                                e = e[0]
                            } else e = null;
                            e && (k.fetchTime = Math.round(e.duration), b && (k.fetchTime += Math.round(b.duration)), "transferSize" in e && (k.transferSize = e.transferSize, b && (k.transferSize += b.transferSize)), d("Log").debug("sdkperf: it took %s ms and %s bytes to load %s", k.fetchTime, k.transferSize, a), j = e.startTime, k.ns = c("sdk.Runtime").getSDKNS(), j && window.setTimeout(function() {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005788747","namespace":"FB","message":"' + e.message + '"}}');
