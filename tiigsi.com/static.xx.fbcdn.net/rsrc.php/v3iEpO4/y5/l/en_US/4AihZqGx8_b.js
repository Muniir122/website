...
(function(a) {
    ...
    function Q() {
        O = null;
        if (!M) throw u("_checkFbtVirtualModuleTimeout timeout queued when _useFbtVirtualModules is false!");
        var a = z(),
            b = Object.keys(N),
        ...
        b.length > 0 && (O = setTimeout(Z()(Q, "_checkFbtVirtualModuleTimeout"), P));
        if (c.length > 0) throw u("The following virtual modules are taking over %s ms to be defined: %s...", P, c.join(",").slice(0, 300))
    }
    ...
    function R(b, c, e, g, h, i, l) {
        c === void 0 ? (c = [], e = b, b = la()) : e === void 0 && (e = c, s.call(b) === "[object Array]" ? (c = b, b = la(c.join(","))) : c = []);
        var m = {
                cancel: ka.bind(this, b)
            },
            n = ia(b);
        if (!c && !e && i) {
            n.refcount += i;
        ...
        n.context = h;
        n.special = g;
        (n.nonJSDeps || sa(n)) && (n.nonJSDeps = !1, L(n));
        U(n);
        if (d.length > 0) {
            var o = d;
            d = [];
            b = a.ScheduleJSWork ? a.ScheduleJSWork : va;
            b(function() {
                if (w) {
    ...
    function ma(a, b, c) {
        ...
        if (c.dependencies != null)
            for (var d = c.depPosition; d < c.dependencies.length; d++) {
                ...
                e.tarjanGeneration != h ? (ma(a, b, e), c.tarjanLow = Math.min(c.tarjanLow, e.tarjanLow)) : e.tarjanOnStack && (c.tarjanLow = Math.min(c.tarjanLow, e.tarjanIndex))
            }
    ...
    function U(a) {
        ...
        ra(a) && d.push(a);
        a.nextDepWaitingHead !== null && qa(a)
    }
    ...
    function Z() {
        var b = a.TimeSlice && a.TimeSlice.guard ? a.TimeSlice.guard : va;
        return function() {
    ...
    if (a.__rl_stub) {
        for (var Y = 0; Y < a.__rl_stub.length; Y++) S.apply(null, a.__rl_stub[Y]);
        delete a.__rl_stub
    }
    F = function() {};
    a.$RefreshReg$ = F;
...
__d("unrecoverableViolation", ["FBLogger"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, d, e) {
        d = d === void 0 ? babelHelpers["extends"]({}, null) : d;
        d = d.error;
        b = c("FBLogger")(b);
...
__d("BootloaderRetryTracker", ["ErrorGuard", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        var b = a.prototype;
        b.getAllRetryAttempts_FOR_DEBUG_ONLY = function() {
            return this.$3
        };
        b.getNumRetriesForSource = function(a) {
            return (a = this.$3.get(a)) != null ? a : 0
        };
        b.maybeScheduleRetry = function(a, b) {
            var d = this,
                e = this.getNumRetriesForSource(a);
            if (!this.$5() || e >= this.$1.retries.length) return !1;
...
__d("Promise", ["ErrorPubSub", "TimeSlice", "err", "setImmediateAcrossTransitions", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f) {
    "use strict";
    var g;
    c = a.Env || {};
    var h = !!c.gk_log_promise_done;
    ...
    o._noop = i;
    o.prototype.then = function(a, b) {
        if (this.constructor !== o) return p(this, a, b);
        var c = new o(i);
        q(this, new u(a, b, c));
        return c
    };
    ...
    function q(a, c) {
        ...
        b("setImmediateAcrossTransitions")(function() {
            ...
            if (b === null) {
                ...
                a._state === 1 ? r(c.promise, a._value) : s(c.promise, a._value);
                return
            }
            b = m(c.continuation.bind(null, b), a._value);
            b === k ? s(c.promise, j) : r(c.promise, b)
        })
    }

    function r(a, b) {
        if (b === a) return s(a, new TypeError("A promise cannot be resolved with itself."));
        if (b && (typeof b === "object" || typeof b === "function")) {
            var c = l(b);
            if (c === k) return s(a, j);
            if (c === a.then && b instanceof o) {
                a._state = 3;
                a._value = b;
                t(a);
                return
    ...
    function s(a, b) {
        a._state = 2, a._value = b, t(a)
    }

    function t(a) {
        for (var b = 0; b < a._deferreds.length; b++) q(a, a._deferreds[b]);
        a._deferreds = null
    }
    ...
    o.prototype.done = function(a, c) {
        h && (g || (g = b("ErrorPubSub"))).reportError(b("err")("Promise.done is deprecated. Please use promiseDone."));
    ...
    o.resolve = function(a) {
        ...
        if (typeof a === "object" || typeof a === "function") try {
            var b = a.then;
            if (typeof b === "function") return new o(b.bind(a))
        } catch (a) {
    ...
    o.all = function(a) {
        Array.isArray(a) || (a = [o.reject(new TypeError("Promise.all must be passed an array."))]);
        ...
        return new o(function(a, c) {
            ...
            function e(f, g) {
                if (g && (typeof g === "object" || typeof g === "function"))
                    if (g instanceof o && g.then === o.prototype.then) {
    ...
    o.allSettled = function(a) {
        if (!Array.isArray(a)) return o.reject(new TypeError("Promise.allSettled must be passed an array."));
        var b = Array(a.length),
            c = function(c, d) {
                var e = a[c];
                d = typeof e === "object" && e !== null && typeof e.then === "function";
                b[c] = d ? new o(function(a, b) {
                    e.then(function(b) {
                        a({
                            status: "fulfilled",
                            value: b
    ...
    o.prototype["finally"] = function(a) {
        return this.then(function(b) {
            return o.resolve(a()).then(function() {
                return b
            })
        }, function(b) {
            return o.resolve(a()).then(function() {
    ...
    d && !!a.Promise && !!a.Promise.allSettled && !!a.Promise.prototype["finally"] ? (a.Promise.prototype.done = o.prototype.done, e.exports = a.Promise) : e.exports = o
}), null);
...
__d("MakeHasteTranslations", ["BootloaderConfig", "BootloaderRetryTracker", "FBLogger", "Promise", "TimeSlice", "err", "fb-error", "getSameOriginTransport", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = new(c("BootloaderRetryTracker"))({
            retries: (e = c("BootloaderConfig").translationRetries) != null ? e : c("BootloaderConfig").jsRetries,
            abortNum: (f = c("BootloaderConfig").translationRetryAbortNum) != null ? f : c("BootloaderConfig").jsRetryAbortNum,
            abortTime: (e = c("BootloaderConfig").translationRetryAbortTime) != null ? e : c("BootloaderConfig").jsRetryAbortTime,
            ...
            f.onreadystatechange = function(g) {
                ...
                e(function() {
                    ...
                    try {
                        ...
                        if (h.maybeScheduleRetry(a, function() {
                                return b(l(a))
                            })) return;
                        d(c("err")("Error processing response. XHR Error: %s, XHR status: %s, Response Text: %s", e.toString(), f.status, f.responseText.length > 300 ? f.responseText.slice(0, 300) + "..." : f.responseText))
                    }
                })
            };
            f.send()
    ...
    var m = "data:application/json;base64";

    function n(a) {
        if (!a.includes(m)) throw c("err")("Invalid data uri mime type");
        a = a.split(",");
        a[0];
        a = a[1];
    ...
    function o(d, e) {
        ...
        return b("regeneratorRuntime").async(function(g) {
            while (1) switch (g.prev = g.next) {
                ...
                case 8:
                    g.next = 10;
                    return b("regeneratorRuntime").awrap(l(e));
                case 10:
                    g.t0 = g.sent;
                case 11:
                    f = g.t0;
                    Object.assign(j, f.translations);
                    f.virtual_modules.forEach(function(b) {
                        return a.define(b, {})
                    });
                    g.next = 20;
                    break;
                case 16:
                    g.prev = 16, g.t1 = g["catch"](2), i["delete"](d), c("FBLogger")("binary_transparency", "translation_download_error").catching(g.t1).mustfix("Unable to download and process translation map. Url: %s", e);
                case 20:
                case "end":
                    return g.stop()
            }
    ...
    g.genFetchAndProcessTranslations = o;
    g.fetchTranslationsForEarlyFlush = d
}), 98);
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderRetryTracker", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "ClientConsistency", "ErrorPubSub", "FBLogger", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "TimeSlice", "cr:696703", "createTrustedScriptURLFromBootloaderDataURI", "createTrustedScriptURLFromFacebookURI", "err", "fb-error", "ifRequireable", "maybeRemoveElement", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    ...
    var r = [],
        ...
        G = new(b("BootloaderRetryTracker"))({
            ...
            abortCallback: function() {
                b("FBLogger")("bootloader").warn("JS retry abort")
            }
        });
    ...
    function Q(a, c, d, e) {
        ...
        a.onload = h.bind(void 0, function() {
            var d = G.getNumRetriesForSource(f);
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            var h = (i || (i = b("performanceAbsoluteNow")))(),
                k = G.maybeScheduleRetry(f, function() {
                    var b = a.parentNode;
                    b && (b.removeChild(a), P(c, d, e, b))
                });
            k || (v.set(c, h), b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, h - g, G.getNumRetriesForSource(f), t.size - u.size), b("NetworkStatus").reportError(), e())
        })
    }
    ...
    function T(a, c, d, e) {
        ...
        if ((c.type === "js" || c.type === "css") && c.p != null && c.d !== 1 && b("BootloaderConfig").hypStep4) {
            ...
            else h.size > 0 && (c.src = S(c.src, h), c.type === "js" && c.tsrc != null && c.tsrc.trim() !== "" && (c.tsrc = S(c.tsrc, h)))
        }
        ...
        switch (c.type) {
            ...
            case "css":
                ...
                b("CSSLoader").loadStyleSheet(a, c.src, d, !c.nc, f, R(a, c, f));
                break;
            case "async":
    ...
    function ca(a, c, e, f) {
        ...
        U((j == null ? void 0 : j.r) || [], {
            ...
            onAll: function() {
                return F.registerCallback(function() {
                    F.notify(F.tierTwoStart(a)), d.call(null, l.map(b("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
        ...
        U((k == null ? void 0 : k.r) || [], {
            ...
            onAll: function() {
                return F.registerCallback(function() {
                    F.notify(F.tierThreeStart(a)), d.call(null, m.map(b("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
    ...
    function W(a) {
        ...
        for (var d = 0; d < a.length; d++) {
            ...
            for (var e = h, f = Array.isArray(e), h = 0, e = f ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                ...
                i = i;
                i = b("nullthrows")(z.get(i), "No hash for rsrcIndex:" + i);
                var j = K(i);
    ...
    function X(a) {
        ...
        c || window._btldr && window._btldr[e] ? d.type === "js" ? f(a) : f() : d.type === "js" ? Q(a, e, d, f) : b("CSSLoader").setupEventListeners(e, d.src, M(), f, R(e, d, f), a)
    }
    ...
    var $ = {
        loadModules: function(a, c, e) {
            ...
            F.registerCallback(d.bind(null, f, function() {
                l && (l.callbackStart = (i || (i = b("performanceAbsoluteNow")))()), h.apply(void 0, arguments), l && (l.callbackEnd = (i || (i = b("performanceAbsoluteNow")))()), F.notify(k)
            }), f.map(function(a) {
                return F.tierOne(a)
            }));
            N(function(b) {
            ...
            if (l) {
                ...
                for (var m = 0; m < f.length; m++) {
                    ...
                    j.add(F.beDone(n));
                    j.add(F.tierThree(n));
                    j.add(F.tierOneLog(n));
                    j.add(F.tierTwoLog(n));
                    j.add(F.tierThreeLog(n))
                }
        ...
        loadResources: function(a, c, d) {
            d === void 0 && (d = "loadResources: unknown caller"), Y(), N(function(e) {
                var f;
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            u.set(a, (i || (i = b("performanceAbsoluteNow")))()), window.CavalryLogger && window.CavalryLogger.done_js([a]), F.notify(F.rsrcDone(a)), c != null && k(c)
        },
        ...
        handlePayload: function(a, c) {
            ...
            a.csrUpgrade && n(a.csrUpgrade).forEach(function(a) {
                return b("CSRBitMap").add(a)
            });
            a.compMap && $.enableBootload(a.compMap, c)
        },
        enableBootload: function(a, b) {
            for (var c in a) b && b.comp++, !w.has(c) ? (w.set(c, a[c]), p.has(c) && (p["delete"](c), J(c))) : b && b.dup_comp++;
            Y();
            q || Z()
        },
...
__d("Event", ["$", "Arbiter", "DOMEvent", "DOMEventListener", "DOMQuery", "DataStore", "ErrorGuard", "EventProfiler", "ExecutionEnvironment", "FBLogger", "Parent", "Scroll", "TimeSlice", "UserAgent", "dedupString", "fb-error", "getDocumentScrollElement", "getObjectValues"], (function(a, b, c, d, e, f) {
    ...
    var k = function() {
        ...
        var c = a.prototype;
        c.getData = function() {
            this.data = this.data || babelHelpers["extends"]({}, null);
            return this.data
        };
        c.stop = function() {
        ...
        AsyncRequest = function() {
            ...
            _proto.specifiesWriteRequiredParams = function specifiesWriteRequiredParams() {
                ...
                return this.writeRequiredParams.every(function(param) {
                    _this7.data[param] = _this7.data[param] || importDefault("Env")[param] || (importDefault("ge")(param) || {}).value;
            ...
            _proto2._transportErrorHandler = function _transportErrorHandler(response) {
                var _this14 = this,
                    ...
                    paths = this._requests.filter(Boolean).map(function(request) {
                        _this14._wrapperRequest && (request.id = _this14._wrapperRequest.id);
...
__d("PersistedQueue", ["BaseEventEmitter", "ExecutionEnvironment", "FBJSON", "Run", "WebStorage", "WebStorageMutex", "err", "guid", "nullthrows", "performanceAbsoluteNow", "requestAnimationFrame"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b) {
            ...
            this.$9 = [j.addListener("active", function() {
                e.$10 != null && (e.$10 = null, e.$13())
            }), j.addListener("inactive", function() {
                e.$10 == null && (e.$10 = Date.now(), e.$14())
            })];
        ...
        b.wrapAndEnqueueItem = function(a) {
            this.$20(a), this.isActive() ? this.$16() : this.$17()
        };
    ...
    if (c("ExecutionEnvironment").canUseDOM) {
        var s = d("Run").maybeOnBeforeUnload(function() {
            j.emit("inactive", null), s == null ? void 0 : s.remove()
        }, !1);
        if (!s) var t = d("Run").onUnload(function() {
            j.emit("inactive", null), t.remove()
        })
    }
    g["default"] = a
}), 98);
...
__d("XD", ["Arbiter", "DOM", "DOMDimensions", "Log", "PHPQuerySerializer", "Queue", "URI", "isFacebookURI", "isInIframe", "resolveWindow", "sdk.Scribe"], (function(a, b, c, d, e, f, g) {
    var h = {
        ...
        _startResizeMonitor: function() {
            var a, b = this,
                d;
            a = (a = document.documentElement) != null ? a : babelHelpers["extends"]({}, null);
            if (this._opts.hideOverflow) {
                a.style.overflow = "hidden";
                ((a = document.body) != null ? a : babelHelpers["extends"]({}, null)).style.overflow = "hidden"
            }
            a = function() {
...
__d("intlSummarizeNumber", ["FbtNumberType", "IntlCompactDecimalNumberFormatConfig", "IntlVariations", "intlNumUtils"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, d, e) {
        ...
        g = f.toString();
        g = (d = d) != null ? (d = d[g]) != null ? d[e.toString()] : d : d;
        if (!g || f < h || g.positive_prefix_pattern === "" && g.positive_suffix_pattern === "") {
            e = b === void 0 ? 0 : b;
            return c("intlNumUtils").formatNumberWithThousandDelimiters(a, e)
        }
    ...
    function l(a, b, d, e, f) {
        var g = b.toString();
        g = (f = f) != null ? (f = f[g]) != null ? f[c("IntlVariations").NUMBER_OTHER.toString()] : f : f;
...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "JSResource", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "uuid"], (function(a, b, c, d, e, f, g) {
    ...
    var h = 5 * 1024,
        ...
        z = Date.now() - n,
        A = 1;
    ((b = c("AnalyticsCoreData").fix_br_init_rc) != null ? b : !1) && P();

    function B(a, b) {
        I(b.item.name, "js.br.add_to_batch", 1, !0);
        var c = b.item.extra.length;
        s + c > h && (clearTimeout(t), C());
        r.push([a, b]);
        s += c
    }
    ...
    function C() {
        ...
        u = !1;
        var a = r;
        G("js.br.send_batch", a.map(function(a) {
            return a[1].item
        }));
        if (!y) {
            H("js.br.init_not_complete.log", a.length);
            var b = function() {
                var b = a[c],
                    d = b[0],
                    e = b[1];
                J.log([e.item], function(a) {
            ...
            return b.log(a.map(function(a) {
                ...
                if (!b) {
                    H("js.br.banzai_fallback", a.length);
                    var c = function() {
                        var c = a[d],
                            b = c[0],
                            e = c[1];
                ...
                for (var c = 0; c < a.length; c++) {
                    var e = a[c],
                        f = e[0];
                    e = e[1];
                    I(e.item.name, "js.br.success_callback.batch.send_batch", 1, !0);
                    f.markItem(e, b)
                }
            })
        });
    ...
    function F(a, b) {
        for (var e = 0; e < a.length; e++) {
            var f, g = a[e];
            I(g.name, "js.banzai.posting_event", 1, !1);
        ...
        G("planes.banzai.write_to_transport", a)
    }
    ...
    function H(a, b) {
        ...
        ((e = c("AnalyticsCoreData").fix_br_init_rc) != null ? e : !1) && (f += ".fix_br_init_rc");
    ...
    var J = {
        log: function(a, b) {
            G("js.banzai.post.log", a), F(a, c("Banzai").BASIC), b(!0)
        },
        logImmediately: function(a, b) {
            G("js.banzai.post.log_immediately", a), F(a, c("Banzai").VITAL), b(!0)
        },
        logCritical: function(a, b) {
            G("js.banzai.post.log_critical", a), F(a, {
                signal: !0,
                retry: !0
            }), b(!0)
        }
    ...
    function K(a) {
        P();
        var b = L(a, "banzai_data_loss", "log"),
            d = L(a, "banzai_data_loss", "logImmediately"),
            e = L(a, "banzai_data_loss", "logCritical"),
            f = L(a, "bladerunner_data_loss", "");
        H("js.br_data_loss.posted." + a, 1);
        if (y && x) try {
            l.enqueue(function(b) {
                return b.log([f], function(b) {
                    if (!b) {
                        H("js.br.transport_failure." + a, 1);
                        J.logCritical([f], function(b) {
                            H("js.br.failure_fallback_success_callback." + a, 1)
                        });
                        return
                    }
                    H("js.br.success_callback." + a, 1)
                })
            })
        } catch (b) {
            H("js.br.error_enqueueing." + a, 1), J.logCritical([f], function(b) {
                H("js.br.enqueuing_fallback_success_callback." + a, 1)
            })
        } else x || H("js.br.failed." + a, 1), y || H("js.br.init_not_complete." + a, 1), J.logCritical([f], function(b) {
            H("js.br.init_fallback_success_callback." + a, 1)
        });
        F([b], c("Banzai").BASIC);
        F([d], c("Banzai").VITAL);
        F([e], {
    ...
    function O(a) {
        l.start(function(b) {
            return b({
                log: function(d, b) {
                    G("planes.bladerunner.write_to_transport", d);
                    var e = JSON.stringify(D(d));
                    a ? c("AnalyticsCoreData").enable_ack ? c("promiseDone")(a.amendWithAck(e), function(a) {
                        G("planes.bladerunner.ack_received" + a.toString(), d), b(a)
                    }, function() {
                        G("planes.bladerunner.ack_failure", d), b(!1)
                    }) : (a.amendWithoutAck(e), G("planes.bladerunner.write_without_ack", d)) : (G("planes.bladerunner.request_stream_null", d), b(!1))
                },
        ...
        c("JSResource").loadAll([c("JSResource")("TransportSelectingClientSingleton").__setRef("FalcoLoggerTransports"), c("JSResource")("RequestStreamCommonRequestStreamCommonTypes").__setRef("FalcoLoggerTransports")], function(a, b) {
            ...
            b = {
                onTermination: function(a) {
                    a.message === "Stream closed" ? (l.stop(!0), v = !1) : (x = !1, l.start(function(a) {
                        return a(J)
                    }))
                },
                onFlowStatus: function(a) {
                    a === e.Started && !((a = c("AnalyticsCoreData").fix_br_init_rc) != null ? a : !1) && O(f)
                }
            };
            c("promiseDone")(a.requestStream({
                method: "Falco"
            }, JSON.stringify(E(d("WebSession").getId())), b, {
                requestId: ""
            }).then(function(a) {
                f = a;
                ((a = c("AnalyticsCoreData").fix_br_init_rc) != null ? a : !1) && O(f);
                y = !0
            })["catch"](function(a) {
                l.stop(!0), v = !1
            }))
    ...
    function Q(a) {
        return c("AnalyticsCoreData").enable_bladerunner && x && a.s === 1
    }
    ...
    function a() {
        ...
        c("PersistedQueue").setHandler("falco_queue_log", function(a) {
            var b, c = R(a.getQueueNameSuffix());
            while (b = a.dequeueItem())(function(b) {
                Q(b.item.policy) ? (I(b.item.name, "js.use_bladerunner.log", 1, !0), P(), t == null && (t = setTimeout(C, i)), B(a, b)) : (I(b.item.name, "js.use_banzai.log", 1, !0), c && (b.item.identity = c), J.log([b.item], function(c) {
        ...
        c("PersistedQueue").setHandler("falco_queue_immediately", function(a) {
            var b, c = R(a.getQueueNameSuffix());
            while (b = a.dequeueItem())(function(b) {
                Q(b.item.policy) ? (I(b.item.name, "js.use_bladerunner.log_immediately", 1, !0), P(), (t == null || !u) && (clearTimeout(t), t = setTimeout(C, j), u = !0), B(a, b)) : (I(b.item.name, "js.use_banzai.log_immediately", 1, !0), c && (b.item.identity = c), J.logImmediately([b.item], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        });
        c("PersistedQueue").setHandler("falco_queue_critical", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                var d = b.item;
                Q(d.policy) ? (I(d.name, "js.use_bladerunner.log_critical", 1, !0), P(), !y ? (I(d.name, "js.br.init_not_complete.logCritical", 1, !0), c && (d.identity = c), J.logCritical([d], function(c) {
                    return a.markItem(b, c)
                })) : l.enqueue(function(e) {
                    return e.logCritical([d], function(e) {
                        if (!e) {
                            H("js.br.banzai_fallback.critical", 1);
                            c && (d.identity = c);
                            J.logCritical([d], function(c) {
                                return a.markItem(b, c)
                            });
                            return
                        }
                        I(b.item.name, "js.br.success_callback.batch.critical", 1, !0);
                        a.markItem(b, e)
                    })
                })) : (c && (d.identity = c), I(d.name, "js.use_banzai.log_critical", 1, !0), J.logCritical([d], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        });
        c("AnalyticsCoreData").enable_dataloss_timer && (P(), M(), N())
    }
    g.attach = a
}), 98);
...
__d("ControlledReferer", ["Bootloader", "CookieConsent", "XRefererFrameController", "getRequestConstUri", "isInstagramURI", "isMessengerDotComURI", "isMetaDotComURI", "isOculusDotComURI", "isWhatsAppBlogURI", "isWorkplaceDotComURI", "justknobx", "lowerFacebookDomain"], (function(a, b, c, d, e, f, g) {
    function h(a, b, d) {
