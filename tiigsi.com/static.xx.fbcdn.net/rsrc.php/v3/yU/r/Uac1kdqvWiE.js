...
__d("BladeRunnerConfig", ["RTISubscriptionManagerConfig", "WebDriverConfig", "cr:3024", "gkx", "isEmpty"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        d.patchRequestHeaders = function(a) {
            ...
            ((f = d.method) == null ? void 0 : f.startsWith("FBGQLS:")) && c("gkx")("4104") && (d.method = "Unified", d["stream-handler"] = "Gqls");
            return d
        };
        return a
    }();
...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "NetworkStatus", "Promise", "qex"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.shutdown = function() {
            this.$31(), this.$32("shutdown"), this.$8 = !1, this.$10.debugTrace("shutdown", "Shutdown")
        };
        ...
        e.publish = function(a, c, e, f) {
            ...
            !i ? (f == null ? void 0 : f.onEvent(d("MqttPublishListener").MqttPublishEvent.NOT_CONNECTED), g.reject(new Error("Client disconnected"))) : this.$34(a, c, e, g);
            return h
        };
        e.unsubscribe = function(a) {
            this.$17["delete"](a);
            this.ensureConnected(o) && this.$35(a);
            return !0
        };
        ...
        e.$31 = function() {
            this.$8 && this.$7 != null && (this.$37("Disconnected"), this.$7 != null && (this.$7.disconnect(), this.$27.onConnectionDisconnect()), this.$7 = null)
        };
        e.$38 = function(a) {
        ...
        e.$37 = function(a) {
            a !== this.$11 && (this.$10.debugTrace("MQTTConnection-updateState", "State changed to: " + a), this.$38(a), this.$11 = a, this.$1(a))
        };
        e.$29 = function(a) {
            var b = this;
            a === void 0 && (a = !1);
            ...
            try {
                ...
                this.$7 != null && (this.$13 += 1, this.$7.connect({
                    userName: h,
                    mqttVersion: 3,
                    getKeepAliveIntervalSeconds: this.$40,
                    getKeepAliveTimeoutSeconds: this.$41,
                    ignoreSubProtocol: !0,
                    onConnectFailure: function(c, d) {
                        return b.$42(c, e, b.$18, g, j, a, f, d)
                    },
                    onConnectSuccess: function() {
                        return b.$43(e, b.$18, g, j, a, f)
                    },
                    onConnection: function() {
                        return b.$44(i, g)
                    },
                ...
                this.$10.bumpCounter("js_error_in_init_exception"), this.$37("Disconnected"), this.$48(!1, !1, e, this.$18, g, [], a, f, 14, "init error - " + b.message), b && this.$10.logErrorWarn(b, "ws_js_error"), this.$27.onWSFatal(), this.$49(new(d("MqttTypes").MqttChannelError)(!1, "ws_js_error", b), "client_init")
            }
        };
        e.$39 = function() {
            var a = this.$4(),
        ...
        e.$48 = function(a, b, c, d, e, f, g, h, i, j) {
            a ? this.$14++ : this.$15++;
            var k = Date.now();
        ...
        e.$42 = function(a, b, c, d, e, f, g, h) {
            ...
            this.$48(!1, a.connAck !== -1, b, c, d, e, f, g, i.errorCode, h);
            if (a.connAck != null) {
        ...
        e.$30 = function() {
            ...
            c("NetworkStatus").onChange(function(b) {
                ...
                if (b && a.$11 === "Disconnected") {
                    b = a.$53();
                    b && (a.$22 != null && (d("MqttEnv").Env.clearTimeout(a.$22), a.$22 = null), a.$29(!0))
                }
            })
        };
        e.$53 = function() {
...
__d("MqttChannel", ["ChannelClientID", "IrisSubscribeChecker", "MqttAnalyticsHook", "MqttConnection", "MqttEnv", "MqttPublishListener", "MqttPublishTimeoutConfig", "MqttUserName", "MqttUtils", "Promise", "isFastRefreshEnabledForCurrentDomain", "promiseDone", "qex", "requireDeferred"], (function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function() {
        ...
        e.$24 = function() {
            var a = this;
            typeof window !== "undefined" && window.addEventListener("unload", function() {
                return a.shutdown()
            })
        };
        e.shutdown = function() {
    ...
    a = function(a) {
        ...
        while (b < a.length) {
            ...
            if (d < 128) c += String.fromCharCode(d);
                ...
                c += String.fromCharCode(55296 + (e >> 10));
                c += String.fromCharCode(56320 + (e & 1023))
            } else if (d >= 245) h([d]);
            else {
                b + 1 >= a.length && i(3, [d]);
                f = a[b++];
                ...
                g >= 128 && g < 192 || h([d, f, g]);
                c += String.fromCharCode((d & 15) << 12 | (f & 63) << 6 | g & 63)
            }
        }
        return c
    };
...
__d("DGWRequestStreamUtils", ["Base64", "WebDriverConfig", "cr:3024", "gkx"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, d, e, f) {
        ...
        (c("gkx")("6000") || c("WebDriverConfig").isTestRunning) && (g["XRSS-http_referer"] = window.location.href);
        if (c("WebDriverConfig").isTestRunning && c("gkx")("5639")) {
            j = b("cr:3024") == null ? void 0 : b("cr:3024").get();
            j != null && (g["XRSS-is_test"] = "1", g["XRSS-original_request_id"] = j)
        }
        return g
    }
...
__d("DGWStream", ["$InternalEnum"], (function(a, b, c, d, e, f) {
    "use strict";
    var g = b("$InternalEnum").Mirrored(["ABNORMAL_CLOSURE", "GOING_AWAY", "SERVER_INTERNAL_ERROR", "PREMATURE_CLOSE", "UNKNOWN_ERROR", "KEEPALIVE_TIMEOUT", "TRANSPORT_CLOSED_BEFORE_STREAM_INIT", "ESTABLISHMENT_TIMEOUT", "UNAUTHORIZED", "REJECTED", "BAD_REQUEST", "DGW_SERVER_ERROR", "ESTABLISHMENT_ERROR"]);
...
__d("DGWRequestStreamRef", ["CompactSerializerPolyfill", "DGWRequestStreamUtils", "DGWStream", "DGWStreamHandler", "InflightAmends", "Promise", "RTISubscriptionManagerConfig", "RequestStreamCloseReason", "RequestStreamCommonRequestStreamCommonTypes", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RequestStreamE2ELogger", "RequestStreamE2ESampling", "RequestStreamSingleChannelSingleChannelRequestStreamSerializers", "RequestStreamSingleChannelSingleChannelRequestStreamTypes", "RequestStreamState", "RequestStreamTransport", "err", "gkx", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b, e, f, g, i) {
            ...
            this.$14 = !1;
            this.$19 = i;
            g != null && (this.$21() || (g.dgwStreamGroupLoggingId = this.$19.getStreamGroupLoggingId()), g.dgwCountPriorStreamsInGroup = this.$19.guessStreamGroupPriorStreamCount());
            ...
            !this.$21() ? this.$6 = d("RequestStreamE2ELogger").createStreamLogger(a, this.$5, d("RequestStreamTransport").RequestStreamTransport.WEB_RS_STARGATE) : this.$7.disableFalcoLogging = !0;
            ...
            this.$18 = new(c("InflightAmends"))(l, function(a, b) {
                var d;
                (d = j.$6) == null ? void 0 : d.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").AMENDMENT_ACK, c("RequestStreamE2EClientLoggerEvent").RECEIVED, babelHelpers["extends"]({}, j.$22(), {
                    latency: b.toString()
                }), a)
            }, function(a, b) {
                if (b.message !== m) {
                    var d;
                    (d = j.$6) == null ? void 0 : d.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").AMENDMENT_ACK, c("RequestStreamE2EClientLoggerEvent").FAILURE, babelHelpers["extends"]({}, j.$22(), {
                        reason: b.message
                    }), a)
                }
            });
        ...
        e.amendWithAck = function(a) {
            a = this.$23(a, !0);
            return a === null || a === void 0 ? b("Promise").resolve(!1) : this.$18.getPromise(a) || b("Promise").resolve(!1)
        };
        ...
        e.cancel = function() {
            ...
            this.$9 = !0;
            this.$24(d("RequestStreamCloseReason").RequestStreamCloseReason.UserIntention, "user cancel the stream", !0)
        };
        e.start = function(a) {
            var e = this;
            a === void 0 && (a = !1);
            var f = String(this.$15++),
                g = Date.now();
            return this.$25(f).then(function() {
                var a;
                e.$14 = !1;
                e.$20 = 0;
                ...
                e.$14 = !1;
                if (c("gkx")("1799") || g !== d("DGWStream").StreamError.ESTABLISHMENT_ERROR) {
                    var h;
                    ...
                    e.$24(a ? d("RequestStreamCloseReason").RequestStreamCloseReason.ReestablishError : d("RequestStreamCloseReason").RequestStreamCloseReason.StartStreamFailure, g.message, !0);
                    throw g
                } else {
                    (h = e.$6) == null ? void 0 : h.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").REQUEST_STREAM, c("RequestStreamE2EClientLoggerEvent").FAILURE, {
            ...
            return b("regeneratorRuntime").async(function(n) {
                while (1) switch (n.prev = n.next) {
                    case 0:
                        ...
                        i = this.$29();
                        this.$13 = i;
                        j = d("DGWRequestStreamUtils").convertHeaders(babelHelpers["extends"]({}, g.headers, this.$30()), g.body != null, this.$5);
                        n.next = 8;
                        return b("regeneratorRuntime").awrap(this.$19.establishStream(j, i, this.$7));
                    case 8:
                        this.$11 = n.sent;
                        n.next = 23;
                        break;
                    case 11:
                        n.prev = 11;
                        n.t0 = n["catch"](2);
                        if (!(n.t0 === d("DGWStream").StreamError.ESTABLISHMENT_ERROR)) {
                            n.next = 15;
                            break
                        }
                        throw n.t0;
                    ...
                    case 30:
                        m = this.$11.send(k).then(function(a) {
                            o(a), e.$9 && e.$24(d("RequestStreamCloseReason").RequestStreamCloseReason.UserIntention, "user cancel the stream", !0)
                        });
                        (f = this.$6) == null ? void 0 : f.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").REQUEST_STREAM, c("RequestStreamE2EClientLoggerEvent").SENT, {}, a, String(this.$17));
                        this.$12 = h;
        ...
        e.$24 = function(a, b, e) {
            ...
            c("gkx")("574") && this.$18.rejectAll(c("err")("stream terminating: " + b));
            (f = this.$13) == null ? void 0 : f.stop();
            this.$11 = null;
            this.$10 = !0;
            this.$32(d("RequestStreamCommonRequestStreamCommonTypes").FlowStatus.Stopped) && this.$3.onFlowStatus(d("RequestStreamCommonRequestStreamCommonTypes").FlowStatus.Stopped);
        ...
        e.$33 = function(a) {
            ...
            if (a.response) {
                ...
                if (!this.$27()) {
                    ...
                    return
                }(g = this.$6) == null ? void 0 : g.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").RECEIVED, q(a.response), f, String(this.$17), e);
                g = a.response.delta;
                ...
                (g = this.$6) == null ? void 0 : g.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").SENT, q(a.response), f, String(this.$17), e);
                a.response.ack_level === d("RequestStreamCommonRequestStreamCommonTypes").AckLevel.Device && a.response.response_id != null && this.$34(a.response.response_id, f)
            } else {
                (g = this.$6) == null ? void 0 : g.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").FAILURE, {
        ...
        e.$34 = function(a, b) {
            ...
            if (this.$11 != null) {
                this.$11.send(a);
                (a = this.$6) == null ? void 0 : a.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE_ACK, c("RequestStreamE2EClientLoggerEvent").SENT, {}, b, String(this.$17))
            } else {
        ...
        e.$29 = function() {
            return new(c("DGWStreamHandler"))(this.$35.bind(this), this.$36.bind(this), this.$31.bind(this), this.$37.bind(this), this.$38.bind(this))
        };
        e.$38 = function(a) {
            ...
            this.$24(d("RequestStreamCloseReason").RequestStreamCloseReason.ServerDataEnd, "Client receive OnServerHasFinishedSendingData and Server will not send more data", !0)
        };
        e.$35 = function(a) {
            (a = this.$6) == null ? void 0 : a.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").REQUEST_STREAM, c("RequestStreamE2EClientLoggerEvent").FAILURE, {
                reason: "OnClose: Server Close Connection"
            }, null, String(this.$17));
            this.$24(d("RequestStreamCloseReason").RequestStreamCloseReason.RemoteTermination, "Client receive OnClose and Server will not send more data", !0)
        };
        e.$36 = function(a) {
            try {
                this.$33(a)
        ...
        e.$22 = function() {
            var a = {};
            c("gkx")("1626") && (a.pending_amendments_size = this.$18.getSize().toString());
            return a
        };
        return a
    }();
...
__d("DGWUtils", ["Base64", "DGWConstants", "DGWCppBridge", "DGWLoggingContext", "Random", "URI", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 4;
        ...
        a.getTransportWithInitialStream = function(c, e, f, g, h) {
            ...
            return b("regeneratorRuntime").async(function(m) {
                while (1) switch (m.prev = m.next) {
                    ...
                    case 8:
                        k = m.sent;
                        l = k.$15 != void 0 ? k.$15 : k.establishGroupedStream(e, c, new(d("DGWLoggingContext").DGWLoggingContext)(f.dgwVersion, c.loggingId, f.serviceId, f.fbId, f.loggingId, c.disableFalcoLogging));
            ...
            return b("regeneratorRuntime").async(function(k) {
                while (1) switch (k.prev = k.next) {
                    case 0:
                        ...
                        this.$6 = this.$6 || d("StreamGroupWebSocketTransport").StreamGroupWebSocketTransport.getTransport_DEPRECATED(h, this.$3, this.$5, function() {
                    ...
                    case 11:
                        ...
                        throw k.t0;
                    case 15:
                        this.$2.containsStreamGroup(this.$1) || this.$2.setStreamGroupAndTransport(this.$1, i);
                        k.next = 23;
                        break;
                    case 18:
                        k.next = 20;
...
__d("MqttFetchClient", ["MqttEnv", "MqttProtocolCodec", "MqttUtils", "Promise", "PromiseResult"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = "fetch_pull",
        i = "fetch_pull_finish",
        j = "fetch_",
    ...
    a = function() {
        function a() {
            this.$1 = "", this.$2 = d("MqttEnv").Env.getLoggerInstance(), this.$3 = 0, this.$4 = "", this.$6 = function() {}, this.$7 = function(a) {}, this.$8 = function() {}, this.$9 = function(a) {}, this.$10 = 0, this.$11 = 0, this.$12 = 0, this.$13 = 0, this.$14 = "Ready", this.$15 = [], this.$16 = [], this.$17 = null, this.$18 = !1, this.$19 = 0
        }
        ...
        e.$25 = function(a, b, e) {
            ...
            c("MqttUtils").promiseDoneWithTimeout(fetch(g, {
                method: "POST",
                mode: "cors",
                cache: "no-cache",
                credentials: "include",
        ...
        e.$31 = function(a) {
            ...
            for (var e = a, f = Array.isArray(e), g = 0, e = f ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                ...
                h = h;
                this.$2.bumpCounter(j + "response_" + h.topic)
            }
        ...
        e.$20 = function() {
            ...
            c("MqttUtils").promiseDoneWithTimeout(fetch(b, {
                method: "POST",
                mode: "cors",
                cache: "no-cache",
                credentials: "include",
...
__d("MqttLongPollingClient", ["MqttEnv", "MqttProtocolCodec", "Promise", "XHRRequest", "getCrossOriginTransport"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 120 * 1e3,
        i = "simple_pull";
    a = function() {
        function a() {
            this.$3 = "", this.$4 = 0, this.$2 = d("MqttEnv").Env.getLoggerInstance(), this.$1 = "Ready", this.$5 = "", this.$7 = function() {}, this.$8 = function(a) {}, this.$9 = function() {}, this.$10 = function(a) {}, this.$11 = 0, this.$12 = null, this.$13 = new Set(["/t_ms", "/messenger_sync_get_diffs", "/messenger_sync_create_queue", "/webrtc", "/rtc_multi"])
        }
        var e = a.prototype;
...
__d("MqttLongPollingRunner", ["MqttEnv", "MqttFetchClient", "MqttLongPollingClient", "MqttLongPollingHookCollection", "MqttTypes", "MqttUtils", "Promise", "exponentialBackoff"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b, e, f, g, h, i, j, k) {
            ...
            this.$18 = new(c("exponentialBackoff"))(this.$23, this);
            this.$20 = 0;
            this.$21 = n;
