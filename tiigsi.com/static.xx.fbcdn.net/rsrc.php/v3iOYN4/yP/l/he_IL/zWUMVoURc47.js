    ...
    a = function(a) {
        ...
        function e() {
            ...
            return (e = f = a.call.apply(a, [this].concat(h)) || this, f.$5 = function() {
                ...
                b = b.shouldBypassPageSentryTest;
                var k = d("MPNIdentity").MPNIdentity.currentUserState(),
                    l = d("MPNIdentity").MPNIdentity.currentUserID();
                e({
                    type: "UPDATE_CONTINUE_CLICK_TIME",
                    continueClickTime: c("performanceAbsoluteNow")()
                });
                if (k == d("MPNIdentity").MPNIdentityState.FB && l != null) {
                    if (!b && !h && !i) {
                        (k = f.props.ActionDelegate) == null ? void 0 : k.openThreadWithInterstitial(function() {
                            var a;
                    ...
                    d("MPNNavigation").navigateToRoute(f.context, f.props.history, d("MPNLocalState").MPNLocalStatePath.THREAD_VIEW);
                    (l = f.props.ActionDelegate) == null ? void 0 : l.openThreadWithCurrentFBUser();
                    d("LiveChatPluginLoggerUtil").logActionFromNewUI("tab_click", null, a, g ? "welcome_page_with_guest_option" : "welcome_page", {
                        button_name: "continue_as"
                    });
                    return
                ...
                d("MPNNavigation").navigateToRoute(f.context, f.props.history, d("MPNLocalState").MPNLocalStatePath.WELCOME_PAGE);
        ...
        f.render = function() {
            ...
            f = a && (!b || this.props.isReengagementDialog);
            a = d("MPNIdentity").MPNIdentity.currentUserState() == d("MPNIdentity").MPNIdentityState.FB;
            b = c("gkx")("1189683");
            a = !e && !b;
            b = e ? j.jsx(c("ShimButton.react"), {
                "data-testid": void 0,
                onClick: this.$1,
                className: "_a2zk",
                children: j.jsx(c("LineClamp.react"), {
                    lines: 1,
                    children: i._( /*FBT_CALL*/ "\u05dc\u05d4\u05de\u05e9\u05d9\u05da \u05db\u05d0\u05d5\u05e8\u05d7" /*FBT_CALL*/ )
                })
            }) : null;
            e = j.jsx(c("ShimButton.react"), {
                onClick: this.$2,
                className: "_a2zk",
                children: j.jsx(c("LineClamp.react"), {
                    lines: 1,
                    children: d("LiveChatPluginFbts").MAYBE_LATER_BUTTON_TEXT
                })
            });
            return this.props.useITPContinueButton ? j.jsx("div", {
                ...
                }), this.props.isReengagementDialog ? e : b]
            })
        };
        f.$6 = function() {
            ...
            if (this.props.isReengagementDialog) return d("LiveChatPluginFbts").OPT_IN_BUTTON_TEXT;
            if (!b) return c ? d("LiveChatPluginFbts").LOGIN_PAGE_USE_MESSENGER_BUTTON_TEXT : i._( /*FBT_CALL*/ {
                "*": "\u05d4\u05ea\u05d7\u05d1\u05e8\/\u05d9 \u05dc-Messenger",
                "1": "\u05d4\u05ea\u05d7\u05d1\u05e8 \u05dc-Messenger",
                "2": "\u05d4\u05ea\u05d7\u05d1\u05e8\u05d9 \u05dc-Messenger",
                "__vcg": 1
            } /*FBT_CALL*/ );
            return a !== null ? i._( /*FBT_CALL*/ {
                "*": "\u05d4\u05de\u05e9\u05da\/\u05d4\u05de\u05e9\u05d9\u05db\u05d9 \u05d1\u05ea\u05d5\u05e8 {first name}",
                "1": "\u05d4\u05de\u05e9\u05da \u05d1\u05ea\u05d5\u05e8 {first name}",
                "2": "\u05d4\u05de\u05e9\u05d9\u05db\u05d9 \u05d1\u05ea\u05d5\u05e8 {first name}",
                "__vcg": 1
            } /*FBT_CALL*/ , [i._param("first name", a)]) : i._( /*FBT_CALL*/ {
                "*": "\u05d4\u05de\u05e9\u05da\/\u05d4\u05de\u05e9\u05d9\u05db\u05d9",
                "1": "\u05d4\u05de\u05e9\u05da",
                "2": "\u05d4\u05de\u05e9\u05d9\u05db\u05d9",
                "__vcg": 1
...
__d("ChatPluginDesktopReEngagementExpandedDialog.react", ["cx", "ChatPluginMessengerAttribution.react", "ChatPluginSetupFlowE2ETestUtils", "Image.react", "LineClamp.react", "LiveChatPluginConstants", "MPNDesktopWelcomePageBottomButtons.react", "MPNDialogMinusButtonSVG.react", "MPNLocalState", "MPNNavigation", "MPNPrivacyText.react", "MPNXDMessageManager", "MessagingPluginContext", "ShimButton.react", "react", "useResizeObserver"], (function(a, b, c, d, e, f, g, h) {
    ...
    function a(a) {
        var b = j(c("MessagingPluginContext")),
            ...
            h = e.windowSize;
        e = e.optimisticStorageState;
        e = e || {};
        var k = e.isGreetingDismissed,
            l = a.isPreview,
            m = a.ActionDelegate,
            n = h === "compact",
            o = function() {
                var a = n ? d("LiveChatPluginConstants").RE_ENGAGEMENT_EXPANDED_DIALOG_HEIGHT_COMPACT : d("LiveChatPluginConstants").RE_ENGAGEMENT_EXPANDED_DIALOG_HEIGHT,
                    b = n ? d("LiveChatPluginConstants").MAIN_IFRAME_PADDING_HEIGHT_WITH_COMPACT : d("LiveChatPluginConstants").MAIN_IFRAME_PADDING_HEIGHT;
                a = a + b;
        ...
        f = h ? "_a968" : "_a969";
        var p = function() {
            l ? m && m.minimize() : (k !== !0 && d("MPNNavigation").maximizeGreetingDialog(b), d("MPNNavigation").navigateToRoute(b, a.history, d("MPNLocalState").MPNLocalStatePath.REENGAGEMENT_COLLAPSED_VIEW))
        };
        return i.jsxs("div", {
            ref: e,
            ...
            children: [i.jsxs("div", {
                ...
                children: [i.jsx("div", {
                    ...
                    children: i.jsx(c("LineClamp.react"), {
                        lines: 1,
                        children: "Opt-in to updates"
                    })
                }), i.jsx("div", {
                    className: "_a9c3",
                    children: i.jsx(c("LineClamp.react"), {
                        lines: 3,
                        children: "If you\u2019d like, we can update you weekly on promos and deals. You can opt-out any time."
                    })
                }), i.jsx(c("MPNDesktopWelcomePageBottomButtons.react"), babelHelpers["extends"]({}, a, {
    ...
    function a() {
        ...
        return j.jsx("div", {
            ...
            children: j.jsxs("div", {
                className: "_94wm",
                children: [j.jsx("div", {
                    children: i._( /*FBT_CALL*/ "\u05d4\u05e9\u05d1\u05ea\u05ea \u05d4\u05d5\u05d3\u05e2\u05d5\u05ea \u05e2\u05d1\u05d5\u05e8 {pageName}" /*FBT_CALL*/ , [i._param("pageName", a.state.pageName)])
                }), i._( /*FBT_CALL*/ "\u05d0\u05d9\u05df \u05d1\u05d9\u05db\u05d5\u05dc\u05ea\u05da \u05dc\u05e9\u05dc\u05d5\u05d7 \u05dc\u05d5 \u05d4\u05d5\u05d3\u05e2\u05d5\u05ea, \u05d5\u05d4\u05d4\u05d5\u05d3\u05e2\u05d5\u05ea \u05e9\u05dc\u05d5 \u05dc\u05d0 \u05d9\u05e9\u05dc\u05d7\u05d5 \u05dc\u05da." /*FBT_CALL*/ ), j.jsx(c("ShimButton.react"), {
                    className: "_94wo",
                    onClick: function() {
                    ...
                    return j.jsx("div", {
                        ...
                        children: j.jsx("div", {
                            ...
                            children: j.jsx(c("CometPressable.react"), {
                                overlayRadius: 50,
                                "aria-label": i._( /*FBT_CALL*/ "\u05ea\u05e4\u05e8\u05d9\u05d8 \u05e7\u05d1\u05d5\u05e2" /*FBT_CALL*/ ),
                                onPress: function() {
                                    a.$4(), d()
                                },
    ...
    function a(a) {
        ...
        return j.jsxs(c("MPNDropdownMenu"), {
            ...
            children: [q && o ? j.jsx(c("MPNDropdownMenuItem"), {
                ...
                primaryText: i._( /*FBT_CALL*/ {
                    "*": "\u05d4\u05de\u05e9\u05da\/\u05d4\u05de\u05e9\u05d9\u05db\u05d9 \u05d1-Messenger",
                    "1": "\u05d4\u05de\u05e9\u05da \u05d1-Messenger",
                    "2": "\u05d4\u05de\u05e9\u05d9\u05db\u05d9 \u05d1-Messenger",
                    "__vcg": 1
                } /*FBT_CALL*/ )
                ...
                primaryText: i._( /*FBT_CALL*/ "\u05e1\u05d9\u05d5\u05dd \u05e6'\u05d0\u05d8" /*FBT_CALL*/ )
                ...
                primaryText: a.isMuted ? i._( /*FBT_CALL*/ "\u05d1\u05d9\u05d8\u05d5\u05dc \u05d4\u05e9\u05ea\u05e7\u05ea \u05e9\u05d9\u05d7\u05d4" /*FBT_CALL*/ ) : i._( /*FBT_CALL*/ "\u05d4\u05e9\u05ea\u05e7\u05ea \u05e9\u05d9\u05d7\u05d4" /*FBT_CALL*/ )
                ...
                primaryText: i._( /*FBT_CALL*/ "\u05d0\u05e0\u05d9 \u05e8\u05d5\u05e6\u05d4 \u05dc\u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05de\u05e9\u05d4\u05d5" /*FBT_CALL*/ )
                ...
                primaryText: i._( /*FBT_CALL*/ "\u05d4\u05d5\u05e1\u05e4\u05ea Messenger \u05dc\u05d0\u05ea\u05e8 \u05e9\u05dc\u05da" /*FBT_CALL*/ )
            })]
        })
    }
    a.displayName = a.name + " [from " + f.id + "]";
            ...
            return j.jsxs("div", {
                ...
                children: [j.jsx("div", {
                    ...
                    children: [l && j.jsx("div", {
                            ...
                            children: function(a, b) {
                                return j.jsx("div", {
                                    ...
                                    children: j.jsx(c("MPNHeaderActionButton.react"), {
                                        label: i._( /*FBT_CALL*/ "\u05e2\u05d5\u05d3" /*FBT_CALL*/ ),
                                        onPress: function() {
                        ...
                        label: i._( /*FBT_CALL*/ "\u05e1\u05d2\u05d5\u05e8" /*FBT_CALL*/ ),
                        onPress: function() {
                            var b;
            ...
            children: i.jsxs("div", {
                ...
                children: [i.jsxs("div", {
                    ...
                    children: [i.jsx("div", {
                        ...
                        children: f ? i.jsx(c("MPNSwitchAccountActionButton.react"), {
                            onPress: function() {
                                o(!0)
                            },
                            testid: void 0
...
__d("MPNDesktopWelcomePageModalView.react", ["cx", "fbt", "BasePopoverTrigger.react", "ChatPluginMessengerAttribution.react", "ChatPluginSetupFlowE2ETestUtils", "FlexLayout.react", "LineClamp.react", "LiveChatPluginConstants", "LiveChatPluginFbts", "LiveChatPluginLoggerUtil", "MPNConstants", "MPNDesktopLoginModal.react", "MPNDesktopWelcomePageBottomButtons.react", "MPNHeaderActionButton.react", "MPNIdentity", "MPNLocalState", "MPNMinusButtonSVG.react", "MPNMoreInfoButtonSVG.react", "MPNNavigation", "MPNNewWelcomePageButtom.react", "MPNPageResponsivenessText.react", "MPNPrivacyText.react", "MPNStorage", "MPNSwitchAccountActionButton.react", "MPNSwitchAccountDropDownMenu.react", "MPNVerifiedBadge.react", "MPNXDMessageManager", "MessagingPluginContext", "MessagingPluginDesktopInformationDropDownMenu.react", "MessagingPluginDesktopProfilePicture.react", "react", "useResizeObserver"], (function(a, b, c, d, e, f, g, h, i) {
    "use strict";
    var j = d("react");
    b = d("react");
    var k = b.useContext,
    ...
    function a(a) {
        var b = k(c("MessagingPluginContext")),
            ...
            t = e.shouldShowEntryPointCustomization,
            u = e.shouldShowNewWelcomeView,
            v = e.pageID,
            w = e.windowSize,
            x = e.awayGreeting,
            y = e.awayHoursEnabled,
            z = e.isPageAway,
            A = e.shouldRenderReEngagementDialog,
            B = e.optimisticStorageState;
        e = n(!1);
        var C = e[0],
            D = e[1],
            E = m(null),
        ...
        l(function() {
            function a(a) {
                var b;
                a = a.target;
                E && a instanceof Node && !((b = E.current) == null ? void 0 : b.contains(a)) && F && a instanceof Node && !((b = F.current) == null ? void 0 : b.contains(a)) && (D(!1), c("MPNStorage").clearRedirectCommand(), c("MPNXDMessageManager").updateShouldShowLoginPage(!1))
            }
        ...
        e = (e = a.shouldShowEntryPointCustomizationFromSetupFlow) != null ? e : t;
        var G = d("MPNIdentity").MPNIdentity.currentUserState() == d("MPNIdentity").MPNIdentityState.FB;
        q = i._( /*FBT_CALL*/ "\u05e6'\u05d0\u05d8 \u05e2\u05dd {pageName}" /*FBT_CALL*/ , [i._param("pageName", q)]);
        var H = w === "compact",
            I = function(a, b) {
                var e = H ? d("LiveChatPluginConstants").WELCOME_PAGE_GUEST_FALLBACK_HEIGHT_WITH_COMPACT : d("LiveChatPluginConstants").WELCOME_PAGE_GUEST_FALLBACK_HEIGHT,
                    f = H ? d("LiveChatPluginConstants").WELCOME_PAGE_NO_GUEST_FALLBACK_HEIGHT_WITH_COMPACT : d("LiveChatPluginConstants").WELCOME_PAGE_NO_GUEST_FALLBACK_HEIGHT,
                    g = H ? d("LiveChatPluginConstants").MAIN_IFRAME_PADDING_HEIGHT_WITH_COMPACT : d("LiveChatPluginConstants").MAIN_IFRAME_PADDING_HEIGHT,
                    h = H ? d("LiveChatPluginConstants").WELCOME_PAGE_ATTRIBUTION_OFFSET_HEIGHT_WITH_COMPACT : d("LiveChatPluginConstants").WELCOME_PAGE_ATTRIBUTION_OFFEST_HEIGHT;
                h = t ? h : 0;
                a = a ? e : f;
        ...
        w = c("useResizeObserver")(function(a, b) {
            I(h, b)
        });
        var J = H ? p : o,
            K = H ? d("MPNConstants").MPNAvailablityIconSize.MEDIUM : d("MPNConstants").MPNAvailablityIconSize.LARGE,
            L = H ? "_a3jw" : "_a3jx";
        s = G ? r : (r = s) != null ? r : d("LiveChatPluginFbts").DEFAULT_LOGGED_IN_GREETING_TEXT;
        x = (r = x) != null ? r : d("LiveChatPluginFbts").DEFAULT_AWAY_GREETING_TEXT.toString();
        r = y && z ? x : s;
        var M = function() {
            var a = d("MPNIdentity").MPNIdentity.currentUserID();
            if (a == null) return;
            d("LiveChatPluginLoggerUtil").logActionFromNewUI("chat_plugin_minimize", a, v, "welcome_page")
        };
        y = u ? j.jsx("div", {
            ref: E,
            className: "_9l4n",
            ...
            children: [j.jsx(c("MPNDesktopWelcomePageBottomButtons.react"), babelHelpers["extends"]({}, a, {
                isReengagementDialog: !1
        ...
        var N = function() {
            d("MPNNavigation").navigateToRoute(b, a.history, d("MPNLocalState").MPNLocalStatePath.REENGAGEMENT_COLLAPSED_VIEW), B.isGreetingDismissed !== !0 && d("MPNNavigation").maximizeGreetingDialog(b)
        };
        return j.jsxs("div", {
            "data-testid": void 0,
            ref: w,
            ...
            children: [j.jsx("div", {
                ...
                children: j.jsxs("div", {
                    ...
                    children: [j.jsxs("div", {
                        ...
                        children: [j.jsx(c("MessagingPluginDesktopProfilePicture.react"), {
                            className: L,
                            availablityIconSize: K
                        }), j.jsx("div", {
                            className: "_9dxh"
                        }), j.jsxs("div", {
                            className: "_9dzn",
                            children: [G && !u ? j.jsx(c("BasePopoverTrigger.react"), {
                                align: "middle",
                                ...
                                children: j.jsx(c("MPNHeaderActionButton.react"), {
                                    ...
                                    onPress: function() {
                                        var b;
                                        A ? N() : (b = a.ActionDelegate) == null ? void 0 : b.minimize();
                                        M()
                                    },
                                    children: j.jsx(c("MPNMinusButtonSVG.react"), {})
                                })
                    ...
                    }), j.jsx(c("MPNPageResponsivenessText.react"), {}), j.jsx(c("LineClamp.react"), {
                        lines: 3,
                        className: "_a2zt" + (u ? " _a6s6" : ""),
                        children: r
                    }), y, j.jsx(c("ChatPluginMessengerAttribution.react"), {
                        shouldShowEntryPointCustomization: e
                    })]
                })
            }), j.jsx("div", {
                ref: F,
                ...
                children: C && j.jsx("div", {
                    ...
                    children: j.jsx("div", {
                        className: "_a8d3",
                        children: j.jsx(c("MPNDesktopLoginModal.react"), babelHelpers["extends"]({}, a, {
    ...
    a = function(a) {
        ...
        e.componentDidMount = function() {
            var a = this.context.state,
                ...
                l = a.windowSize,
                m = a.shouldShowNewWelcomeView;
            a = a.shouldShowReEngagement;
            k = k.visibility === d("MPNConstants").MPNVisibility.NOT_HIDDEN;
            c("MPNXDMessageManager").setupDesktopIframe(b, e, f, d("MessagingPluginPathUtils").MPN_PATH.ITPCONTINUE, k, !0, i, j, l, a);
            d("LiveChatPluginLoggerUtil").logImpressionUsingXController_SafeFor3PD(g, "itp_page", h, ["continue"], null, null, null, null, null, null, null, !1, m)
        };
        e.render = function() {
            try {
...
__d("MPNDesktopIcon.react", ["ChatPluginEntryPoint.react", "ClickableArea.react", "LiveChatPluginLoggerUtil", "LiveChatPluginMessengerIconSVGWithColor.react", "MPNXDMessageManager", "cr:352", "react"], (function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        f.componentDidMount = function() {
            ...
            d("LiveChatPluginLoggerUtil").logImpressionUsingXController_SafeFor3PD(f, "plugin_icon", g, null, null, null, null, h, null, a, b, e, !1, i, c)
        };
        f.render = function() {
            var a = this.props,
                e = a.alignment,
    ...
    a = function(a) {
        ...
        e.$13 = function() {
            var a = this,
                ...
                d = i._( /*FBT_CALL*/ "\u05d4\u05d4\u05e7\u05dc\u05d3\u05d4 \u05de\u05d5\u05e9\u05d1\u05ea\u05ea \u05d1\u05e9\u05d9\u05d7\u05d4 \u05d6\u05d5." /*FBT_CALL*/ );
            return b ? j.jsx("div", {
                className: "_664k",
                children: d
            }) : j.jsx("div", {
                ...
                children: j.jsx(c("AbstractTextInput.react"), {
                    ...
                    placeholder: i._( /*FBT_CALL*/ "\u05d4\u05e6\u05d2\u05ea \u05e9\u05d0\u05dc\u05d4..." /*FBT_CALL*/ ).toString(),
    ...
    a = function(a) {
        ...
        e.componentDidMount = function() {
            var a = this.context.state,
                ...
                c = a.pluginMountTime,
                e = a.hasGuestMode;
            a = a.shouldShowNewWelcomeView;
            var f = d("MPNIdentity").MPNIdentity.currentUserState() == d("MPNIdentity").MPNIdentityState.FB;
            d("LiveChatPluginLoggerUtil").logImpressionUsingXController_SafeFor3PD(b, e ? "welcome_page_with_guest_option" : "welcome_page", c, e ? [f ? "continue_as" : "chat_in_messenger", "continue_as_guest"] : ["chat_in_messenger"], null, null, null, null, null, null, null, !1, a)
        };
        e.render = function() {
            var a;
...
__d("MessagingPluginDesktopWelcomeMessagePage.react", ["ChatPluginStyleUtils", "LiveChatPluginFbts", "LiveChatPluginLoggerUtil", "MPNConstants", "MPNDialogMinusButtonSVG.react", "MPNLocalState", "MPNNavigation", "MPNXDMessageManager", "MessagingPluginContext", "MessagingPluginPathUtils", "ShimButton.react", "react", "useResizeObserver"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        var b, e = j(c("MessagingPluginContext"));
        ...
        var f = b.alignment,
            ...
            p = b.pageID,
            q = b.serverTime,
            r = b.clientRequestTime,
            s = b.entryPointLabel,
            t = b.entryPointSize,
            u = b.windowSize,
            v = b.awayGreeting,
            w = b.awayHoursEnabled,
            x = b.isPageAway,
            y = b.shouldShowReEngagement,
            z = b.optimisticStorageState;
        b = m(!1);
        var A = b[0],
            B = b[1];
        b = l(null);
        var C = c("useResizeObserver")(function(a, b) {
            a = b.clientHeight + 12;
            c("MPNXDMessageManager").resizeIframe(a, y)
        });
        k(function() {
            d("LiveChatPluginLoggerUtil").logImpressionUsingXController_SafeFor3PD(p, "bubble", q, null, null, null, null, r)
        }, [p, r, q]);
        var D = function() {
                a.ActionDelegate && a.ActionDelegate.minimize(), window.setTimeout(function() {
                    ...
                    c("MPNXDMessageManager").setupDesktopIframe((b = f) != null ? b : "right", (b = g) != null ? b : 0, (b = n) != null ? b : 0, d("MessagingPluginPathUtils").MPN_PATH.WELCOME, !1, null, s, t, (b = u) != null ? b : "standard", y);
                    b = {
            ...
            E = function() {
                d("MPNNavigation").minimizeGreetingDialog(e), d("MPNNavigation").dismissGreetingDialog(e), z.path === d("MPNLocalState").MPNLocalStatePath.BUBBLE && c("MPNXDMessageManager").navigateToWelcomePage(!0)
            },
            F = i(function() {
                window.setTimeout(function() {
                    var b;
                    d("MPNNavigation").navigateToRoute(e, a.history, d("MPNLocalState").MPNLocalStatePath.WELCOME_PAGE);
                    c("MPNXDMessageManager").setupDesktopIframe((b = f) != null ? b : "right", (b = g) != null ? b : 0, (b = n) != null ? b : 0, d("MessagingPluginPathUtils").MPN_PATH.WELCOME, !0, null, s, t, (b = u) != null ? b : "standard", y);
                    b = {
                        path: d("MPNLocalState").MPNLocalStatePath.WELCOME_PAGE,
                        chatState: d("MPNLocalState").MPNChatState.CHAT_NOT_STARTED,
                        visibility: d("MPNConstants").MPNVisibility.NOT_HIDDEN
        ...
        var G = function() {
            ...
            H = function() {
                c("MPNXDMessageManager").markInteraction(), F(), G()
            },
            I = function() {
                d("MPNNavigation").minimizeGreetingDialog(e), d("MPNNavigation").dismissGreetingDialog(e), c("MPNXDMessageManager").markInteraction(), c("MPNXDMessageManager").navigateToWelcomePage(!1), G()
            },
            J = d("ChatPluginStyleUtils").getWelcomeMessageBubbleStyle(f === "left", "desktop"),
            K = d("ChatPluginStyleUtils").getWelcomeMessageTextStyle(f === "left", "desktop"),
            L = d("ChatPluginStyleUtils").getMinusButtonStyle(f === "left", "desktop");
        A = d("ChatPluginStyleUtils").getMinusButtonVisibility(A);
        var M = d("ChatPluginStyleUtils").getNoOutlineFocus();
        o = (o = o) != null ? o : d("LiveChatPluginFbts").DEFAULT_LOGGED_IN_GREETING_TEXT.toString();
        v = (v = v) != null ? v : d("LiveChatPluginFbts").DEFAULT_AWAY_GREETING_TEXT.toString();
        w = w && x ? v : o;
        return h.jsxs("div", {
            style: A,
            ref: b,
        ...
        return h.jsx(d("ReactRouterDOM").BrowserRouter, {
            children: h.jsxs(d("ReactRouterDOM").Switch, {
                children: [h.jsx(d("ReactRouterDOM").Route, {
                    ...
                    render: function(a) {
                        return g ? h.jsx(c("ChatPluginGreetingTextEmptyDialog.react"), babelHelpers["extends"]({}, a)) : h.jsx(c("MessagingPluginDesktopWelcomeMessagePage.react"), babelHelpers["extends"]({}, a, {
                            ActionDelegate: e
                        }))
                    },
                    exact: !0,
                    ...
                    render: function(a) {
                        return h.jsx(c("ChatPluginReEngagementCollapsedDialog.react"), babelHelpers["extends"]({}, a, {
                            isPreview: !1,
                            isMobile: !1
                        }))
                    },
                    exact: !0,
                    path: d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_COLLAPSED
                }), h.jsx(d("ReactRouterDOM").Route, {
                    render: function(a) {
                        return h.jsx(c("ChatPluginDesktopReEngagementExpandedDialog.react"), babelHelpers["extends"]({}, a, {
                            ActionDelegate: e,
                            isPreview: !1
                        }))
                    },
                    exact: !0,
                    path: d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_EXPANDED
...
__d("MPNDesktopWrapper.react", ["Arbiter", "Bootloader", "ChatPluginEntryPoint.react", "ChatPluginStyleUtils", "CreateCustomerChatPluginGuestUserMutation", "LiveChatMqttClient", "LiveChatPluginConstants", "LiveChatPluginLoggerUtil", "LiveChatPluginMessengerIconSVGWithColor.react", "MPNConstants", "MPNDesktopIcon.react", "MPNDesktopRoute.react", "MPNEntryPointAvailabilityStatusIcon.react", "MPNIdentity", "MPNLocalState", "MPNNavigation", "MPNStorage", "MPNUnreadCountBadge.react", "MPNXDMessageManager", "MessagingPluginContext", "MessagingPluginDesktopWelcomeMessagePage.react", "MessagingPluginGuestUpgradeActions", "MessagingPluginPathUtils", "MessagingPluginSDKActionUtil", "MessagingPluginThreadActions", "ReactDOM", "react"], (function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        e.$5 = function() {
            ...
            return a === d("MPNConstants").MPNRedirect.NEW_GUEST_SESSION || a === d("MPNConstants").MPNRedirect.FB_LOG_IN || a === d("MPNConstants").MPNRedirect.RE_ENGAGEMENT_LOG_IN ? d("MessagingPluginPathUtils").MPN_PATH.THREAD : this.props.path
        };
        e.componentDidMount = function() {
            var a = this.context.state,
                b = a.alignment,
        ...
        e.$7 = function() {
            var a = this,
                ...
                k = b.entryPointSize,
                l = b.entryPointIconEnum,
                m = b.shouldShowReEngagement,
                n = b.windowSize,
                o = b.entryPointLabel,
                p = b.optimisticStorageState,
                q = this.context.state;
            b = j ? h.jsx(c("ChatPluginEntryPoint.react"), {
                entryPointIcon: q.entryPointIconSVG,
                entryPointLabel: q.entryPointLabel,
                entryPointSize: k,
                threadColor: q.threadCSSColor,
                alignment: q.alignment
            }) : h.jsx(c("LiveChatPluginMessengerIconSVGWithColor.react"), {
                threadColor: q.threadCSSColor,
                entryPointSize: k
            });
            c("MPNXDMessageManager").setupIconIframe(this.$1, e, f, g, b, i, this.$10(), q.entryPointLabel, l, k, m, "desktop");
                ...
                try {
                    if (b.data.frameName != null && !a.iconIframeLoaded) {
                        var e = h.jsx(c("MPNDesktopIcon.react"), {
                                alignment: q.alignment,
                                threadColor: q.threadCSSColor,
                                entryPointIconSVG: q.entryPointIconSVG,
                                entryPointIconEnum: q.entryPointIconEnum,
                                entryPointLabel: q.entryPointLabel,
                                entryPointSize: k,
                                actionDelegate: a.ActionDelegate,
                                pageID: q.pageID,
                                pluginRequestTime: b.data.request_time,
                                initialVisibility: q.optimisticStorageState.visibility,
                                clientRequestTime: q.clientRequestTime,
                                shouldShowEntryPointCustomization: q.shouldShowEntryPointCustomization,
                                logId: b.data.log_id,
                                serverRequestTime: q.serverTime
                            }),
                            g = parent.frames[b.data.frameName].document.body;
                        d("ReactDOM").render(e, g);
                    ...
                    if (b.data.availabilityStatusIframeName != null) {
                        e = h.jsx(c("MPNEntryPointAvailabilityStatusIcon.react"), {
                            awayHoursEnabled: q.awayHoursEnabled,
                            isPageAway: q.isPageAway
                        });
                    ...
                    if (b.data.greetingIframeName != null)
                        if (e) {
                            g = p.visibility === d("MPNConstants").MPNVisibility.HIDDEN;
                            if (!g && a.initialPath === d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_COLLAPSED) {
                                e = n === "compact";
                                g = d("ChatPluginStyleUtils").getDesktopGreetingBottomSpacingWithReEngagementDialog(g, (g = f) != null ? g : 0, o, k, e);
                                c("MPNXDMessageManager").updateGreetingIframeBottomSpacing(g)
                            }
                            e = h.jsx(c("MessagingPluginDesktopWelcomeMessagePage.react"), {
                                context: a.context,
                                ActionDelegate: a.ActionDelegate
                            });
        ...
        e.$13 = function(a) {
            ...
            c.visibility === d("MPNConstants").MPNVisibility.HIDDEN && (d("MPNNavigation").maximizePlugin(this.context, !1), a && (this.$4 = window.setTimeout(function() {
        ...
        e.render = function() {
            ...
            switch (this.actionOnInit) {
                ...
                case i.RE_ENGAGEMENT_LOG_IN:
                    ...
                    d("MessagingPluginThreadActions").openThreadWithCurrentFBUser(this.context, !0);
                    break;
                case i.RE_ENGAGEMENT_SWITCH_ACCOUNT:
                    this.actionOnInit = i.NONE;
                    c("MPNStorage").clearRedirectCommand();
                    d("MPNIdentity").MPNIdentity.subscribeLoggedInUserChanges(function(b, e) {
                        if (e !== "0") {
                            b = c("MPNStorage").getFBStorageState();
                            b != null && (c("MPNStorage").setFBStorageState(babelHelpers["extends"]({}, b, {
                                rdr: d("MPNConstants").MPNRedirect.RE_ENGAGEMENT_LOG_IN
                            })), d("MPNNavigation").dismissReEngagementDialog(a.context), c("MPNXDMessageManager").reloadPlugin())
                        }
                    }, d("LiveChatPluginConstants").LOGIN_CHECK_INTERVAL);
                    break;
                default:
            ...
            return this.context.state.optimisticStorageState.visibility == d("MPNConstants").MPNVisibility.NOT_HIDDEN || this.iconIframeLoaded || this.context.state.shouldShowReEngagement && this.initialPath === d("MessagingPluginPathUtils").MPN_PATH.BUBBLE ? h.jsx(c("MPNDesktopRoute.react"), {
    ...
    a = function() {
        function a(a) {
            var b = a.alignment,
                ...
                ja = a.shouldShowEntryPointCustomization,
                ka = a.loggedInAccessToken,
                L = a.isSanitizedEpd3pdRequest,
                la = a.shouldShowSizingCustomization,
                M = a.shouldShowNewWelcomeView,
                ma = a.shouldShowPresence,
                na = a.shouldShowReEngagement,
                oa = a.shouldBypassPageSentryTest,
                N = a.entryPointSize,
                pa = a.windowSize,
                qa = a.awayHoursEnabled,
                O = a.awayGreeting,
                ra = a.isPageAway,
                sa = a.nextAvailableTimestamp,
                ta = a.optInMessageEnabled,
                ua = a.optInMessageCadence,
                P = a.collapsedOptInMessageTitle,
                va = a.expandedOptInMessageTitle,
                wa = a.collapsedOptInMessageText;
            a = a.expandedOptInMessageText;
            try {
                this.$1(b, c, d, e, f, g, h, i, j, k, l, m, n, o, s, t, p, q, r, u, v, w, x, y, z, A, B, C, D, E, F, G, H, I, J, aa, ba, ca, da, ea, fa, ga, ha, ia, K, ja, ka, L, la, M, ma, na, oa, N, pa, qa, O, ra, sa, ta, ua, P, va, wa, a)
            } catch (a) {}
        }
        var b = a.prototype;
        b.$1 = function(a, b, e, f, g, h, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H, I, J, aa, ba, ca, da, ea, fa, ga, ha, ia, K, ja, ka, L, la, M, ma, na, oa, N, pa, qa, O, ra, sa, ta, ua, P, va, wa, xa, ya, za) {
            var Aa = !1;
            c("MPNStorage").initialize(p, b, n);
            d("MPNIdentity").MPNIdentity.hasStorageAccess(function(Q) {
                var R, S;
                d("MPNIdentity").MPNIdentity.init(Q, M);
                var T = n,
                    U = w;
                U && (d("MPNCacheVersioning").isLatestVersion(U.v) || (c("MPNStorage").clearThirdPartyStorageState(), U = null));
                R = (R = U) == null ? void 0 : R.rdet;
                R = c("MPNStorage").getShouldRenderReEngagementDialog(N, P, R);
                S = (S = (S = U) == null ? void 0 : S.isGreetingDismissed) != null ? S : !1;
                U || (U = c("MPNStorage").getDefaultOptimisticStorageState(!1, H, G, R, N, S), c("MPNStorage").setThirdPartyStorageState(U));
                var Ba = !1,
                    Ca, Da, V = U.visibility,
                ...
                if (Q) {
                    ...
                    c("MPNStorage").isAccessTokenExpired() && (c("MPNStorage").clearFBStorageState(), U = c("MPNStorage").getDefaultOptimisticStorageState(!1, H, G, R, N, S), c("MPNStorage").setThirdPartyStorageState(U));
                    if ($ != null && $.requestID != null && $.requestID != "") {
                        Z = $.requestID;
                        ($.rdr === d("MPNConstants").MPNRedirect.NEW_GUEST_SESSION || $.rdr === d("MPNConstants").MPNRedirect.ITP_CONTINUE_SESSION) && (T = Z, c("MPNStorage").initialize(p, b, Z))
                    }
                    Aa = c("MPNStorage").setInitialStateIfNecessary(!1, V, H, X, Y, R, W, S);
                    $ = c("MPNStorage").getFBStorageState();
                    if ($ != null) {
                        Ba = $.chatState != d("MPNLocalState").MPNChatState.CHAT_NOT_STARTED;
                        Ca = $.accessToken;
                        Da = $.userID;
                        V = $.visibility;
                ...
                X = d("MessagingPluginPathUtils").getDesktopDisplayPathFromStoredState(Q, U, M, c("MPNStorage").getFBStorageState(), R);
                Y = X === d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_COLLAPSED || X === d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_EXPANDED;
                if (X === d("MessagingPluginPathUtils").MPN_PATH.THREAD && U.chatState === d("MPNLocalState").MPNChatState.CHAT_NOT_STARTED || Y && !R) {
                    W = c("MPNStorage").getDefaultPath(!1, V, H, R);
                    X = d("MessagingPluginPathUtils").MessagingPluginPathUtils.toMobilePath(W);
                    U = babelHelpers["extends"]({}, U, {
                        path: W
                    });
                    c("MPNStorage").setThirdPartyStorageState(U)
                ...
                if (N) {
                    Z = c("MPNStorage").getDefaultVisibility({
                        visibility: U.visibility,
                        greetingVisibility: d("MPNConstants").MPNVisibility.HIDDEN
                    }, d("MessagingPluginPathUtils").MessagingPluginPathUtils.toEnumPath(X), N, H, S, !1);
                    X === d("MessagingPluginPathUtils").MPN_PATH.BUBBLE ? (U = babelHelpers["extends"]({}, U, {
                        visibility: Z.visibility,
                        greetingVisibility: Z.greetingVisibility
                    }), c("MPNStorage").setThirdPartyStorageState(U)) : X === d("MessagingPluginPathUtils").MPN_PATH.REENGAGEMENT_COLLAPSED ? (U = babelHelpers["extends"]({}, U, {
                        path: d("MessagingPluginPathUtils").MessagingPluginPathUtils.toEnumPath(X),
                        visibility: d("MPNConstants").MPNVisibility.NOT_HIDDEN,
                        greetingVisibility: Z.greetingVisibility
                ...
                $ = {
                    ...
                    shouldShowEntryPointCustomization: L,
                    shouldShowSizingCustomization: ma,
                    shouldShowNewWelcomeView: na,
                    shouldShowPresence: oa,
                    shouldShowReEngagement: N,
                    shouldBypassPageSentryTest: pa,
                    entryPointSize: qa,
                    windowSize: O,
                    awayHoursEnabled: ra,
                    awayGreeting: sa,
                    isPageAway: ta,
                    nextAvailableTimestamp: ua,
                    optInMessageEnabled: P,
                    optInMessageCadence: va,
                    collapsedOptInMessageTitle: wa,
                    expandedOptInMessageTitle: xa,
                    collapsedOptInMessageText: ya,
                    expandedOptInMessageText: za,
                    shouldRenderReEngagementDialog: R
                };
                c("MPNXDMessageManager").setShouldShowEntryPointCustomization(L);
                (Q = document.body) == null ? void 0 : (Y = Q.classList) == null ? void 0 : Y.add("_a2w-");
                (V = document.body) == null ? void 0 : (W = V.classList) == null ? void 0 : W.add("_95ry");
                S = O === "compact";
                c("MPNStorage").setWindowSizeMode(S);
                S && ((Z = document.body) == null ? void 0 : (T = Z.classList) == null ? void 0 : T.add("_a3u7"));
